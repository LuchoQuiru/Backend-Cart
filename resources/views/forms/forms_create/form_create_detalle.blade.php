        ...
        <script src="https://cdn.jsdelivr.net/npm/bootstrap@4.0.0/dist/js/bootstrap.min.js" integrity="sha384-JZR6Spejh4U02d8jOt6vLEHfe/JQGiRRSQQxSfFWpi1MquVdAyjUar5+76PVCmYl" crossorigin="anonymous"></script>
            ...
            <!-- Modal -->
                ...
                <div class="modal fade" id="modal_detalle_pedido_nuevo" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    ...
                    <div class="modal-body">
                        ...
                        <form onsubmit="return validateForm()" action="{{ url('tablaPedidos/agregarProductoAlNuevoPedido') }}" name="formDetalle" id="formDetalle" method="POST" enctype="multipart/form-data">    
                        @csrf
                        <div class="mb-3">
